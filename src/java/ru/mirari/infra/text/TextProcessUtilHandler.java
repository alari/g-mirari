 ...
 */
public class TextProcessUtilHandler {
    ...
    static private final Logger log = Logger.getLogger(TextProcessUtilHandler.class);
    ...
    static public Transformer getTransformer() {
        if (transformerThreadLocal.get() == null) {
            try {
                File xsltFile = new ClassPathResource("markdown.xsl", TextProcessUtilHandler.class).getFile();
